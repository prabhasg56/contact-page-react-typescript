...
const Contacts = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-2 ">
      {!showForm && <button className="shadow bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded-full"
      ...
      {/* Contact form */}
     {showForm && <form className="w-full max-w-sm bg-green-200 p-4" >
